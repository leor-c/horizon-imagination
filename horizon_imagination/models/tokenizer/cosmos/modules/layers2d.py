...
from horizon_imagination.models.tokenizer.cosmos.modules.patching import Patcher, UnPatcher
from horizon_imagination.models.tokenizer.cosmos.modules.utils import Normalize, nonlinearity
...
class ResnetBlock(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.norm1 = Normalize(in_channels) if normalize else nn.Identity()
        self.conv1 = nn.Conv2d(in_channels, out_channels, kernel_size=3, stride=1, padding=1)
        self.norm2 = Normalize(out_channels) if normalize else nn.Identity()
