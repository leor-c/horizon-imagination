...
from horizon_imagination.models.tokenizer.cosmos.modules.utils import batch2time, time2batch
...
class ColorLoss(torch.nn.Module):
    ...
    def forward(self, inputs, output_batch, iteration) -> dict[str, torch.Tensor]:
        ...
        recon = weights * torch.abs(inputs[INPUT_KEY].contiguous() - reconstructions.contiguous()) ** 2
