...
from horizon_imagination.models.tokenizer.cosmos.training.configs.base.model import DefaultModelConfig
from horizon_imagination.models.tokenizer.cosmos.training.configs.registry import register_configs
from horizon_imagination.models.tokenizer.cosmos.training.trainer import TokenizerTrainer
...
def make_config():
    ...
    import_all_modules_from_package("diffusion_wm.models.tokenizers.cosmos.training.configs.experiments")
